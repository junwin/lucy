"""Integration tests for chats_endpoints.py against the SQLite chat2 backend.

Tests every endpoint impl against a real Chat2Store backed by
SqliteChat2Primitives, with a mock AgentManager.
"""
...
def store(tmp_path: Path) -> SqliteChat2Primitives:
    """SQLite-backed primitives shared across tests, closed in teardown."""
...
def chat2_store(store: SqliteChat2Primitives) -> Chat2Store:
    """Chat2Store wrapping the SQLite-backed primitives."""
